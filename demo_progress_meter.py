...
# def barras_progreso():
#     # layout the form
#     barra_energia1 = [[sg.Text('This meter is manually updated 4 times')],
#             [sg.ProgressBar(max_value=10, orientation='h', size=(20, 20), key='progress')]]
#     barra_energia2 = [[sg.Text('This meter is manually updated 4 times')],
#             [sg.ProgressBar(max_value=10, orientation='h', size=(20, 20), key='progress2')]]

#     # create the form`
#     # must finalize since not running an event loop
#     window = sg.Window('Custom Progress Meter', barra_energia1, finalize=True)
#     window2 = sg.Window('Custom Progress Meter', barra_energia2, finalize=True)

#     # Get the element to make updating easier
#     progress_bar = window['progress']
#     progress_bar2 = window2['progress2']

#     # -------------------- Your Program Code --------------------
#     # Spot #1 to indicate progress
#     progress_bar.update_bar(1)         # show 10% complete
#     progress_bar2.update_bar(2)         # show 20% complete
#     sleep(1)

#     # more of your code.... perhaps pages and pages of code.
#     # Spot #2 to indicate progress
#     progress_bar.update_bar(2)         # show 20% complete
#     progress_bar2.update_bar(4)         # show 40% complete
#     sleep(1)

#     # more of your code.... perhaps pages and pages of code.
#     # Spot #3 to indicate progress
#     progress_bar.update_bar(6)         # show 60% complete
#     progress_bar2.update_bar(9)         # show 90% complete
#     sleep(1)
